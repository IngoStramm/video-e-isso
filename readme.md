...
- Vídeo é Isso (Nome do plugin)
- vei (nome dos arquivos, nome do text domain e slug da url do repositório)
- VEI_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- vei_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Vídeo é Isso, através do próprio sistema de atualizações do WordPress
